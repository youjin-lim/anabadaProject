...
public class JobVO {
	...
	public String getJ_etc() {
		if(j_etc == null) { //  기타(선택사항) 아무것도 선택안했을 때
			this.j_etc = "";  // db에 null로 저장됨
		}
		 
		return j_etc;
	}
	public void setJ_etc(String j_etc) {
		this.j_etc = j_etc;
	}
	...
	public String toString() {
		return "JobVO [id=" + id + ", j_bno=" + j_bno + ", j_title=" + j_title + ", j_company=" + j_company
				...
				+ j_end + ", j_content=" + j_content + ", j_etc=" + j_etc + ", j_date=" + j_date + ", j_heart="
				+ j_heart + ", j_img=" + j_img + "]";
	}
