...
<body>
	<form action="/putIn/putIn_done" method="get">
		...
		<input type="hidden" name="j_method" value="${scri.j_method }">
			...
			<tr>
				...
				<td>
					<div id="career1" style="display:inline-block;">
						회사명 <input type="text" name="p_company" id="p_company1">
						시작 <input class="monthpicker" type="text" name="p_start" id="p_start1">
						종료 <input class="monthpicker" type="text" name="p_end" id="p_end1">
					</div>
					<!-- 이 부분 반복문으로 돌리기 -->
					<%for(int i = 2; i <= 3; i++) {%>
					<div id="career<%=i%>" style="display:none">
						회사명 <input type="text" name="p_company" id="p_company<%=i%>">
						시작 <input class="monthpicker" type="text" name="p_start" id="p_start<%=i%>">
						종료 <input class="monthpicker" type="text" name="p_end" id="p_end<%=i%>">
					</div>
					<%} %>
					<br>
					<div>
