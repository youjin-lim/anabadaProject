	...
	<div>
		...
		<form name="writeForm"   enctype="multipart/form-data"  >
			...
			<table>
				...
				<tr>
					<td colspan="2"><textarea class="chk" title="내용을 입력하세요" id="p_content" name="p_content" rows="50" cols="80" placeholder="제품의 상세 정보를 기입해주세요. 직거래시 가능한 장소도 알려주세요."></textarea></td>
				</tr>
				<tr>
					<td colspan="2">
